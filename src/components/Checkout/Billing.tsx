...
import { updateBilling } from "@/redux/features/checkout-slice";
      ...
      <div className="bg-white shadow-1 rounded-[10px] p-4 sm:p-8.5">
        <div className="flex flex-col lg:flex-row gap-5 sm:gap-8 mb-5">
          <div className="w-full">
            ...
            <input
              ...
              onChange={(e) =>
                dispatch(updateBilling({ first_name: e.target.value }))
              }
          ...
          <div className="w-full">
            ...
            <input
              ...
              onChange={(e) =>
                dispatch(updateBilling({ last_name: e.target.value }))
              }
              className="rounded-md border border-gray-3 bg-gray-1 placeholder:text-dark-5 w-full py-2.5 px-5 outline-none duration-200 focus:border-transparent focus:shadow-input focus:ring-2 focus:ring-blue/20"
            />
          </div>
        ...
        <div className="mb-5">
          ...
          <input
            ...
            onChange={(e) =>
              dispatch(updateBilling({ address_1: e.target.value }))
            }
            className="rounded-md border border-gray-3 bg-gray-1 placeholder:text-dark-5 w-full py-2.5 px-5 outline-none duration-200 focus:border-transparent focus:shadow-input focus:ring-2 focus:ring-blue/20"
          />
        </div>
        ...
        <div className="mb-5">
          ...
          <input
            ...
            onChange={(e) =>
              dispatch(updateBilling({ country: e.target.value }))
            }
            className="rounded-md border border-gray-3 bg-gray-1 placeholder:text-dark-5 w-full py-2.5 px-5 outline-none duration-200 focus:border-transparent focus:shadow-input focus:ring-2 focus:ring-blue/20"
          />
        </div>
